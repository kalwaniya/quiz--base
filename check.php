...
@keyframes leelaanimate{
   ...
   <body>
     <div class="container text-center" >
     	<br><br>
    	<h1 class="text-center text-success text-uppercase animateuse" >  SAMYAK QUIZ </h1>
    	<br><br><br><br>
      <table class="table text-center table-bordered table-hover">
         ...
         $Resultans = 0;
        	...
        	<td>
            <?php
            echo "Out of 7, You have attempt ".$checked_count." option."; ?>
            </td>
            ...
            $finalresult = " insert into user(username,totalques, answerscorrect) values ('$name','7','$Resultans') ";
